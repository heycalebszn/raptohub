...
const Hero = () => {
  ...
  const rotateStyle = {
    transform: `rotateY(${(mousePosition.x / window.innerWidth - 0.5) * 10}deg) rotateX(${(mousePosition.y / window.innerHeight - 0.5) * -10}deg)`,
  };
  ...
  return (
    <div className="relative pt-24 pb-12 md:pt-32 md:pb-24 overflow-hidden">
      ...
      <div className="absolute top-10 right-20 h-16 w-16 md:h-32 md:w-32 rounded-full border border-neon-pink opacity-20 animate-float" style={{ animationDelay: '0s' }} />
      <div className="absolute top-60 right-40 h-8 w-8 md:h-16 md:w-16 rounded-full border border-neon-blue opacity-20 animate-float" style={{ animationDelay: '1.5s' }} />
      <div className="absolute top-80 left-20 h-12 w-12 md:h-24 md:w-24 rounded-full border border-neon-purple opacity-20 animate-float" style={{ animationDelay: '1s' }} />
        ...
        <div className="grid md:grid-cols-5 gap-12 items-center">
          <div className="md:col-span-3 space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl font-bold leading-tight">
                ...
                <span className="relative mx-2">
                  <span className="relative z-10 bg-gradient-to-r from-neon-blue via-neon-purple to-neon-pink bg-clip-text text-transparent">{typedText}</span>
                  ...
                  <span className="animate-pulse ml-0.5 inline-block h-8 w-1 bg-neon-pink" style={{ display: typedText.length === fullText.length ? 'none' : 'inline-block' }}></span>
                </span>
                Journey
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-300 leading-relaxed">
                Discover curated resources for developers, auditors, and professionals in the blockchain ecosystem.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {statsData.map(stat => (
                <div key={stat.id} className="bg-cyber-light/30 backdrop-blur-sm p-4 rounded-xl border border-primary-500/20 transform transition-transform duration-300 hover:scale-105">
              ...
              >
                ...
                <div className="relative z-10 space-y-6">
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">Get started with these top Web3 learning materials</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-cyber-dark/60 p-4 rounded-lg border border-primary-500/20 hover:border-primary-500/40 transition-all duration-300">
                      <h4 className="font-medium text-neon-purple mb-1">Solidity Documentation</h4>
                      <p className="text-gray-300 text-sm mb-2 line-clamp-1">Official documentation for Solidity, the smart contract programming language for Ethereum.</p>
                    ...
                    <div className="bg-cyber-dark/60 p-4 rounded-lg border border-primary-500/20 hover:border-primary-500/40 transition-all duration-300">
                      <h4 className="font-medium text-neon-blue mb-1">Rust Book</h4>
                      <p className="text-gray-300 text-sm mb-2 line-clamp-1">The official Rust programming language book. Comprehensive guide to the language fundamentals.</p>
                      <div className="flex justify-between items-center">
                        <span className="text-xs bg-primary-500/20 text-primary-300 px-2 py-0.5 rounded-full">
                          Rust
                        </span>
                  ...
                  <a href="#resources" className="block text-center text-sm text-neon-purple hover:text-neon-blue transition-colors duration-300">
                    View all resources →
                  </a>
                </div>
              </div>
