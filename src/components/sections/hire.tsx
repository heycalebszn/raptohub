      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-300">
            Our team of experienced Web3 developers can bring your blockchain
            vision to life
          </p>
        </div>
            ...
            <div className="glassmorphism rounded-2xl p-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <blockquote className="text-gray-300 italic mb-4">
                  "The team delivered our DeFi project ahead of schedule with
                  impeccable code quality. Their blockchain expertise was
                  evident throughout the development process."
                </blockquote>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        <option value="" disabled>
                          Select Crypto Currecncy
                        </option>
                        <option value="small">$USDC </option>
                        <option value="small">$SOL</option>
                        <option value="small">$ETH</option>
                        <option value="medium">$TON</option>
                      </select>
                    </div>
