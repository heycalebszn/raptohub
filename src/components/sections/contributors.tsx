  ...
  const contributors = [
    {
      ...
      bio: 'Smart contract specialist with 5+ years of experience in Solidity development and DeFi protocols.',
    ...
    },
    {
      ...
      bio: 'React expert specialized in blockchain UIs, wallet connections, and interactive dApps.',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h2 className="text-4xl font-bold mb-4">
            Our <span className="bg-gradient-to-r from-neon-pink to-neon-purple bg-clip-text text-transparent">Contributors</span>
          </h2>
            ...
            >
              ...
              <div className="p-6 relative z-10">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-neon-purple text-sm mb-3">{contributor.role}</p>
              ...
              {/* Hover link overlay */}
              <div className="absolute inset-0 flex items-center justify-center bg-cyber-darker/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none group-hover:pointer-events-auto">
                <a 
                  href={contributor.github} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="px-4 py-2 bg-neon-purple text-white rounded-lg flex items-center space-x-1 hover:bg-white hover:text-neon-purple transition-all duration-300"
                >
