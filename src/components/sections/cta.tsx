...
const CTA = () => {
  ...
  return (
    <div className="relative py-20 overflow-hidden">
      ...
      <div
        className="absolute bottom-10 left-20 w-32 h-32 border border-neon-pink rounded-full opacity-10 animate-pulse-slow"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute -bottom-20 right-20 w-40 h-40 border-2 border-neon-green rounded-full opacity-10 animate-float"
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="text-center md:text-left space-y-4 max-w-2xl">
                  ...
                  <p className="text-gray-300">
                    Connect with fellow developers, share resources, ask
                    questions, and collaborate on projects. Join our growing
                    community of Web3 enthusiasts and blockchain professionals.
                  </p>
                  ...
                  <div className="mt-4 md:mt-6 flex flex-col sm:flex-row items-center gap-4">
                    ...
                    <div className="flex flex-col gap-3 w-full">
                      ...
                      <a
                        ...
                        className="group flex items-center justify-center px-8 py-3 bg-gradient-to-r from-neon-green to-neon-blue text-white font-semibold rounded-lg shadow-neon-blue hover:shadow-neon-green transition-all duration-300 hover:-translate-y-1 cursor-pointer transform"
                      >
