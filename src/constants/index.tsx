...
export const resourcesData: Resource[] = [
  ...
  },
  {
    ...
    description:
      "Alchemy’s free courses provide in-depth knowledge on Ethereum and web3 dev tools, making it easy to go from novice to pro. Best for diving into decentralized development with EVM focus.",
